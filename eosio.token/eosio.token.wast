(module
 ...
 (table 5 5 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5eosio5token4burnENS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token6createEyNS_5assetE $_ZN5eosio5token8transferEyyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token5issueEyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE)
 (memory $0 1)
 (data (i32.const 4) "0k\00\00")
 ...
 (data (i32.const 992) "### BURN ###\n\n\00")
 (data (i32.const 1008) "*** O s\c3\admbolo \c3\a9 v\c3\a1lido \n\00")
 (data (i32.const 1040) "*** Memo tem at\c3\a9 256 bytes [ok] \n\00")
 (data (i32.const 1088) "token with symbol does not exist, can\'t burn token\00")
 (data (i32.const 1152) "*** O s\c3\admbolo do token existe\n\00")
 (data (i32.const 1184) "*** A quantia n\c3\a3o \c3\a9 inv\c3\a1lida\n\00")
 (data (i32.const 1232) "must burn positive quantity\00")
 (data (i32.const 1264) "*** A quantia \c3\a9 positiva\n\00")
 (data (i32.const 1296) "*** O s\c3\admbolo \c3\a9 preciso\n\00")
 (data (i32.const 1328) "*** Criou \"accounts\"\n\00")
 (data (i32.const 1360) "no balance object found\00")
 (data (i32.const 1392) "*** Tentando fazer um accounts.get\n +++++ f.balance.amount: \00")
 (data (i32.const 1456) "\n +++++ quantity.amount: \00")
 (data (i32.const 1488) "\n\00")
 (data (i32.const 1504) "overdrawn balance, can\'t burn\00")
 (data (i32.const 1536) "*** Saldo \c3\a9 maior ou igual que a quantia\00")
 ...
 (data (i32.const 1696) "*** O supply foi queimado\00")
 (data (i32.const 1728) "*** Saldo da conta foi subtra\c3\addo\00")
 (data (i32.const 1776) " ## sub_balance ## \n\00")
 (data (i32.const 1808) " ** criando from_acnts \n\00")
 (data (i32.const 1840) " ** consultando \n\00")
 (data (i32.const 1872) "overdrawn balance\00")
 (data (i32.const 1904) " ** Tentando fazer um accounts.get\n +++++ f.balance.amount: \00")
 (data (i32.const 1968) "** from.balance.amount == value.amount \n\00")
 (data (i32.const 2016) "** from_acnts.erase( from );\n\00")
 (data (i32.const 2048) "** else \n\00")
 (data (i32.const 2064) "** from_acnts.modify( from, owner, [&]( auto& a ) \n\00")
 (data (i32.const 2128) "** a.balance -= value; \n\00")
 ...
 (data (i32.const 2336) "cannot transfer to self\00")
 (data (i32.const 2368) "to account does not exist\00")
 (data (i32.const 2400) "unable to find key\00")
 (data (i32.const 2432) "must transfer positive quantity\00")
 (data (i32.const 2464) "onerror\00")
 (data (i32.const 2480) "eosio\00")
 (data (i32.const 2496) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 2560) "get\00")
 ...
 (export "_ZN5eosio5token4burnENS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE" (func $_ZN5eosio5token4burnENS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE))
 ...
 (func $_ZN5eosio5token4burnENS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i64)
  (local $4 i64)
  (local $5 i32)
  (local $6 i64)
